...
contract TwoKeyContract is StandardToken {
  ...
  function TwoKeyContract(address _owner, string _name, string _symbol,
        ...
        uint256 _units, string _ipfs_hash, address _erc20) public {
...
//   // ERC20 public erc20;
//   //
//   function TwoKeyPresellContract(address _owner, string _name, string _symbol,
//         uint256 _tSupply, uint256 _quota, uint256 _cost, uint256 _bounty,
//         uint256 _units, string _ipfs_hash, address _erc20) public {
//
//   }
//     // TwoKeyContract(_owner, _name, _symbol, _tSupply, _quota, _cost, _bounty,
    //     _units, _ipfs_hash)
  // public {
  //   erc20 = ERC20(_erc20);
  // }
  // function getConstantInfo() public view returns (string,string,uint256,uint256,uint256,uint256,address,string) {
  //   uint256 _total_units = erc20.balanceOf(address(this));
  //   return (name,symbol,cost,bounty,quota,_total_units,owner,ipfs_hash);
  // }
// }
...
contract TwoKeyAdmin {
  ...
  function createTwoKeyContract(string _name, string _symbol,
    uint256 _totalSupply, uint256 _quota, uint256 _cost, uint256 _bounty,
    uint256 _units, string _ipfs_hash, address _erc20) public returns (address) {
    address _owner = msg.sender;
    address c;
    // if (_erc20 == address(0)) {
      c = (new TwoKeyContract(_owner, _name, _symbol, _totalSupply,
        _quota, _cost, _bounty, _units, _ipfs_hash, _erc20));
    // } else {
    //   c = (new TwoKeyPresellContract(_owner, _name, _symbol, _totalSupply,
    //     _quota, _cost, _bounty, _units, _ipfs_hash, _erc20));
    // }
