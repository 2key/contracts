...
contract TwoKeyPlasmaEvents {
    ...
    function visited(address c, address contractor, bytes sig) public {
        ...
        address last_address = plasmaOf(msg.sender);
        ...
        require(plasmaOf(influencers[influencers.length-1]) == last_address, 'only the last in the link can call visited');
    ...
    // return a list of address that came from "from"
