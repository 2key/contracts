...
export class Superuser extends TC.TypeChainContract {
  ...
  public constructor(web3: any, address: string | BigNumber) {
    const abi = [
      ...
      {
        constant: false,
        inputs: [{ name: "_newSuperuser", type: "address" }],
  ...
  static async createAndValidate(
    ...
    const contract = new Superuser(web3, address);
  ...
  public get ROLE_SUPERUSER(): Promise<string> {
    return TC.promisify(this.rawWeb3Contract.ROLE_SUPERUSER, []);
  }
  ...
  public isSuperuser(_addr: BigNumber | string): Promise<boolean> {
    return TC.promisify(this.rawWeb3Contract.isSuperuser, [_addr.toString()]);
  }
  ...
  public transferSuperuserTx(
    _newSuperuser: BigNumber | string
  ): TC.DeferredTransactionWrapper<TC.ITxParams> {
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(
      this,
      "transferSuperuser",
      [_newSuperuser.toString()]
    );
  }
