...
export class Contactable extends TC.TypeChainContract {
  ...
  static async createAndValidate(
    ...
    const contract = new Contactable(web3, address);
  ...
  public get contactInformation(): Promise<string> {
    return TC.promisify(this.rawWeb3Contract.contactInformation, []);
  }
  ...
  public setContactInformationTx(
    _info: string
  ): TC.DeferredTransactionWrapper<TC.ITxParams> {
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(
      this,
