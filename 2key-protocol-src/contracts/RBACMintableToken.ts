...
export class RBACMintableToken extends TC.TypeChainContract {
  ...
  ): Promise<RBACMintableToken> {
    const contract = new RBACMintableToken(web3, address);
  ...
  public get ROLE_MINTER(): Promise<string> {
    return TC.promisify(this.rawWeb3Contract.ROLE_MINTER, []);
  }
  ...
  public addMinterTx(
    _minter: BigNumber | string
  ): TC.DeferredTransactionWrapper<TC.ITxParams> {
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(this, "addMinter", [
      _minter.toString()
    ]);
  }
  public removeMinterTx(
    _minter: BigNumber | string
  ): TC.DeferredTransactionWrapper<TC.ITxParams> {
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(
      this,
