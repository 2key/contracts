...
export class TwoKeySignedAcquisitionContract extends TC.TypeChainContract {
  ...
  ): Promise<TwoKeySignedAcquisitionContract> {
    const contract = new TwoKeySignedAcquisitionContract(web3, address);
  ...
  public get _total_units(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract._total_units, []);
  }
