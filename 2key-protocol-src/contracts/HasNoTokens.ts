...
export class HasNoTokens extends TC.TypeChainContract {
  ...
  static async createAndValidate(
    ...
    const contract = new HasNoTokens(web3, address);
  ...
  public tokenFallback(
    _from: BigNumber | string,
    _value: BigNumber | number,
    _data: string[]
  ): Promise<void> {
    return TC.promisify(this.rawWeb3Contract.tokenFallback, [
      _from.toString(),
      _value.toString(),
