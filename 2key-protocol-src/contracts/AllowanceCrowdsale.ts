...
export class AllowanceCrowdsale extends TC.TypeChainContract {
  ...
  static async createAndValidate(
    ...
    const contract = new AllowanceCrowdsale(web3, address);
  ...
  public get tokenWallet(): Promise<string> {
    return TC.promisify(this.rawWeb3Contract.tokenWallet, []);
  }
  ...
  public get remainingTokens(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract.remainingTokens, []);
  }
