...
export class DeprecatedERC721 extends TC.TypeChainContract {
  ...
  ): Promise<DeprecatedERC721> {
    const contract = new DeprecatedERC721(web3, address);
  ...
  public tokensOf(_owner: BigNumber | string): Promise<BigNumber[]> {
    return TC.promisify(this.rawWeb3Contract.tokensOf, [_owner.toString()]);
  }
