...
python3 generate_bytecode.py upgradeContract TwoKeyAdmin 1.0.27
python3 generate_bytecode.py upgradeContract TwoKeyBaseReputationRegistry 1.0.1
python3 generate_bytecode.py upgradeContract TwoKeyFeeManager 1.0.15
python3 generate_bytecode.py upgradeContract TwoKeyUpgradableExchange 1.0.18
python3 generate_bytecode.py approveNewCampaign CPC_PUBLIC 1.0.44
