...
python3 generate_bytecode.py upgradeContract TwoKeyBudgetCampaignsPaymentsHandler 1.0.9
python3 generate_bytecode.py upgradeContract TwoKeyUpgradableExchange 1.0.35
python3 generate_bytecode.py upgradeContract TwoKeyAdmin 1.0.34
