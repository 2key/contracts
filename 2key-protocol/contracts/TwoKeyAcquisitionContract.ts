...
export class TwoKeyAcquisitionContract extends TC.TypeChainContract {
  ...
  ): Promise<TwoKeyAcquisitionContract> {
    const contract = new TwoKeyAcquisitionContract(web3, address);
