...
export class TwoKeyFixedRateExchange extends TC.TypeChainContract {
  ...
  ): Promise<TwoKeyFixedRateExchange> {
    const contract = new TwoKeyFixedRateExchange(web3, address);
