...
export class IncreasingPriceCrowdsale extends TC.TypeChainContract {
  ...
  public constructor(web3: any, address: string | BigNumber) {
    const abi = [
      ...
      {
        inputs: [
          { name: "_initialRate", type: "uint256" },
          { name: "_finalRate", type: "uint256" }
        ],
        payable: false,
  ...
  ): Promise<IncreasingPriceCrowdsale> {
    const contract = new IncreasingPriceCrowdsale(web3, address);
  ...
  public get finalRate(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract.finalRate, []);
  }
  ...
  public get initialRate(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract.initialRate, []);
  }
  ...
  public get getCurrentRate(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract.getCurrentRate, []);
  }
