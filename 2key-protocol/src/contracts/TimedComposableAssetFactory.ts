...
export class TimedComposableAssetFactory extends TC.TypeChainContract {
  ...
  ): Promise<TimedComposableAssetFactory> {
    const contract = new TimedComposableAssetFactory(web3, address);
